<section class="bg-black-100 text-white-100">
    ...
    <?php if (isset($_COOKIE['msg'])) 
        { ?>
            ...
            <strong aligin = "center" style="color:blue; font-size:large">Success!</strong> <?php echo $_COOKIE['msg']; ?>
            </div>
        <?php        
        }
        ...
        ?>
            ...
            <strong aligin = "center" style="color:red; font-size:large">Danger!</strong> <?php echo $_COOKIE['msg_fail']; ?>
            </div>
        <?php   
        }?>  
