...
<div class="mx-auto p-4 max-w-screen-xl pt-10 h-[65vh]">
    <form action="?mod=movie&act=store" method="post" role="form">
        <div class="relative z-0 w-full mb-6 group">
            <input type="text" name="title" id="title" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" value="<?= $_SESSION['data']['title'] ?>" placeholder=" " required />
        ...
        <div class="relative z-0 w-full mb-6 group">
            ...
            <select name="movie_type" id="movie_type" class="py-2.5 px-2 mt-4 w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <option value="tv_series" <?php echo $movie = $_SESSION['data']['movie_type'] === 'tv_series' ? "selected" : ""  ?> >TV Series</option>
                <option value="movie" <?php echo $movie = $_SESSION['data']['movie_type'] === 'movie' ? "selected" : ""  ?>>Movie</option>
                <option <?php echo $movie = $_SESSION['data']['movie_type'] === null ? "selected" : ""  ?> >Choose a type</option>
            </select>
        </div>
        <div class="grid md:grid-cols-2 md:gap-6">
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" name="released_year" id="released_year" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required value="<?= $_SESSION['data']['released_year'] ?>" />
        ...
        <div class="grid md:grid-cols-2 md:gap-6">
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" name="imdb_rating" id="imdb_rating" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value="<?= $_SESSION['data']['imdb_rating'] ?>" />
